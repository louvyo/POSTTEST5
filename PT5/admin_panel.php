...
if (isset($_POST['add_product'])) {
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO `produk`(nama, harga, gambar) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if (isset($_POST['update_product'])) {
    ...
    $update_query = mysqli_query($conn, "UPDATE `produk` SET nama = '$update_p_name', harga = '$update_p_price', gambar = '$update_p_image' WHERE id = '$update_p_id'");
